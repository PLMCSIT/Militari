...
namespace Semantics_Analyzer
{
    public class SemanticsInitializer : SyntaxAnalyzer
    {
        ...
        //    if (node.GetChildAt(0).GetName() == "Prod_varUnitBody")
        //    {
        //        Boolean isdeclared = false;
        //        int line, col;
        ...
        //        {
        //            if (dtype == "unit")
        //                if (node.GetChildAt(0).GetChildAt(1).GetChildAt(0).GetChildAt(2).GetName() == "Prod_varUnitBody")
        //                {
        //                    if(node.GetChildAt(0).GetChildAt(1).GetChildAt(0).GetChildAt(2).GetChildAt(0).GetName() == "=")
        //                    {
